...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .put("/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "questionNo":"SAMPLE_TEXT", "questionName":"SAMPLE_TEXT", "questionType":"SAMPLE_TEXT", "subject":"SAMPLE_TEXT", "createTime":"2020-01-01T00:00:00.000Z", "lastUpdateTime":"2020-01-01T00:00:00.000Z", "deleted":"0", "code":"SAMPLE_TEXT", "author":"SAMPLE_TEXT", "optionA":"SAMPLE_TEXT", "optionB":"SAMPLE_TEXT", "optionC":"SAMPLE_TEXT", "optionD":"SAMPLE_TEXT", "answer":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
