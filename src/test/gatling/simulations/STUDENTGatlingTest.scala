...
class STUDENTGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the STUDENT entity")
        ...
        .repeat(2) {
            ...
            .put("/api/sTUDENTs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "user_no":"SAMPLE_TEXT", "gender":"0", "age":"0", "avatar_url":"SAMPLE_TEXT", "school":"SAMPLE_TEXT", "classess":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
